...
logging.basicConfig(filename='launcher.engine.log', level=logging.INFO,
                    format=u'#%(levelname)-5s %(filename)-21s[LINE:%(lineno)-3d] in:%(funcName)-23s [%(asctime)s] %(message)s')
